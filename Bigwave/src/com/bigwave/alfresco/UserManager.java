...
public class UserManager
{
    ...
    private static final String PREFERENCES_XPATH   = NamespaceService.APP_MODEL_PREFIX + ":" + "preferences";
     ...
     */
    public NodeRef getUserPreferencesRef( final NodeRef person ) throws InvalidNodeRefException , Exception
    {
     ...
     * @throws InvalidNodeRefException
     */
    public NodeRef createUserPreferencesRef( final NodeRef person ) throws InvalidNodeRefException , Exception
    {
    ...
    public Map<QName, Serializable> getUserPreferences( final NodeRef person )
    {
        ...
        NodeRef preferenceRef;
        try
        {
            preferenceRef = getOrCreateUserPreferencesRef(person, false);
    ...
    private NodeRef getOrCreateUserPreferencesRef( final NodeRef person , final boolean createIfMissing ) throws InvalidNodeRefException , Exception
    {

        NodeRef prefRef = null;

        // if (nodeService.hasAspect(person,
        // ApplicationModel.ASPECT_CONFIGURABLE) == false)
        // {
        // if (createIfMissing)
        // {
        ...
        // final NodeRef configRef =
        // configurableService.getConfigurationFolder(person);
        // if (configRef == null)
        // {
        // logger.error("Unable to find associated 'configurations' folder for node: "
        // + person);
        // }
        // else
        // {
        // final List<NodeRef> nodes = searchService.selectNodes(configRef,
        // PREFERENCES_XPATH, null, namespaceService, false);
        //
        // if (nodes.size() == 1)
        // {
        // prefRef = nodes.get(0);
        ...
        // nodeService.createNode(configRef, ContentModel.ASSOC_CONTAINS,
     ...
     *            the configurableService to set
     */
